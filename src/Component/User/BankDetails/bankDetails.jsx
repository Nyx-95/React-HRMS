...
const BankDetails = () => {
    ...
    return (
        ...
        <>
            <div className={`row ${BankDetailsCss.myAttendanceMain}`}>
                <div className={`row ${BankDetailsCss.headingMain}`}>
                    <div className={`row ${BankDetailsCss.headingInner}`}>
                        <div className={`col-10 col-sm-10 col-md-10 col-lg-8 col-xl-8 ${BankDetailsCss.headingWrapper}`}>
                            <h4> My Attendance Report</h4>
                            <img src={headingpicture}></img>
                        </div>
                        <div className={`col-lg-3 col-xl-3 entrieSelectWrapperJQ ${BankDetailsCss.entrieSelectWrapper}`} >
                            <label>Show</label>
                        ...
                        <div className={`col-lg-1 col-xl-1 searchIconMainJQ ${BankDetailsCss.searchIconMain}`}>
                            <a href='#'><i className="ri-search-line"></i></a>
                        </div>
                        <div className="col-2 col-sm-2 col-md-2 mobilenav">
                            <div className={BankDetailsCss.dropDownContainer}>
                ...
                <div className={`row ${BankDetailsCss.myAttendanceTableMain}`}>
                    <div className={BankDetailsCss.UserDetailsMenuTable}>
                        <div className={BankDetailsCss.UserDetailsMenuTableInner}>

                            <table className={`table ${BankDetailsCss.attendanceTable}`}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Individual- salaried/Employed</td>
                                        <td>Aaron Cecil</td>
                                        <td> Cecil John</td>
                                        <td>Male</td>
                                        <td>Married</td>
                    ...
                    <div className={BankDetailsCss.UserBankDetailTableShow}>
                        <div className="col-lg-12 ">
                            <div className={BankDetailsCss.DetailsMenuShowButtonLastRow}>
                                <label>Show</label>
                                <select id={BankDetailsCss.DetailsHeadingRightSelectNumberLastRow}>
                                    <option value="1">1</option>
                        ...
                        <div className="col-lg-12 ">
                            <nav aria-label="Page navigation example">
                                <ul className={`pagination ${BankDetailsCss.pagination}`}>
                                    ...
                                    <li className="page-item "><a className={`page-link ${BankDetailsCss.pageLink}`} href="#">1</a></li>
